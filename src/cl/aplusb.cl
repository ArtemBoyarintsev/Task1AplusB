...
__kernel void aplusb(__global const float* as, __global const float* bs, __global float *cs, unsigned int count)
{
    ...
    /*if (i==20) { // this will create an error in position 20
        cs[i] = 5;
        return;
    }*/
    cs[i] = as[i] + bs[i];
